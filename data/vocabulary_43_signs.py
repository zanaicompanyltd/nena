VOCABULARY = [
    ...
    },
    {
        "id": "asante",
        "swahili_text": "Asante",
        "description": "A person bringing both hands together at the chest with fingers clasped or interlocked close to the sternum, then moving the joined hands slightly downward and forward away from the body as a grateful bowing gesture meaning thank you",
        "reference_img": None,
    },
    {
        "id": "mbaya",
        "swahili_text": "Mbaya",
        "description": "A person raising the right hand with the thumb pointing downward in a thumbs-down shape at chest level, then sweeping the arm in a downward arc across the body as a sign meaning bad or not good",
        "reference_img": None,
    },
    {
        "id": "maji",
        "swahili_text": "Maji",
        "description": "A person holding the right hand in a loose curved claw shape at chest level with fingers bent and grouped pointing downward, then shaking or bouncing the hand downward in a short repeated dripping motion as a sign meaning water",
        "reference_img": None,
    },
    {
        "id": "tafadhali_au_samahani",
        "swahili_text": "Tafadhali / Samahani",
        "description": "A person starting with both hands loosely held at waist level then raising both hands together upward toward the chin with fingers spreading open as they rise, finishing with both open palms facing outward in a pleading or requesting gesture meaning please or sorry",
        "reference_img": None,
    },
    {
        "id": "chakula",
        "swahili_text": "Chakula",
        "description": "A person forming a bunched hand with all fingertips pinched together pointing upward and bringing it up to tap the lips or chin area once or twice in a feeding gesture meaning food or meal",
        "reference_img": None,
    },
    {
        "id": "jina_langu",
        "swahili_text": "Jina langu ni",
        "description": "A person holding both hands at chest level then drawing the right flat hand inward and pressing it firmly against the sternum in a deliberate self-referencing gesture, the hand resting flat on the chest to indicate oneself meaning my name is",
        "reference_img": None,
    },
    {
        "id": "kwaheri",
        "swahili_text": "Kwaheri",
        "description": "A person starting with hands resting at waist level then raising the right open hand with all five fingers extended to head or shoulder height and waving it side to side in a clear open-palm farewell gesture meaning goodbye",
        "reference_img": None,
    },
